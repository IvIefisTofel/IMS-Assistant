                ...
                '<div class="ng-image-gallery-content" ng-show="!imgLoading" ng-click="backgroundClose($event);">' +
                  ...
                  '<div class="description-container">' +
                    ...
                    '<div class="destroy-icons-container">' +
                      // External link icon
                      '<a class="ext-url" ng-show="activeImg.extUrl" ng-href="{{activeImg.extUrl}}" target="_blank"></a>' +
                      // Close Icon (hidden in inline gallery)
                      '<div class="close" ng-click="methods.close();" ng-if="!inline"></div>' +
                    '</div>' +
                    '<div class="description-bg" ng-show="activeImg.desText"></div>' +
                    '<div class="description-text" ng-show="activeImg.desText">' +
                      '<h2>{{activeImg.desText}}</h2>' +
                    '</div>' +
                  '</div>' +
                  // Prev-Next Icons
              ...
              scope.setActiveImg = function(imgObj){
                ...
                if (
                    ...
                    (
                        ...
                        scope.images.indexOf(scope.activeImg) - scope.images.indexOf(imgObj) !=
